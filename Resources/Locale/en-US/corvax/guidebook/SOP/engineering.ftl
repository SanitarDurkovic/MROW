...
guidebook-SOP-StationEngineer-prohibited = 1. Строить дополнительные источники питания (гравитационный сингулярный двигатель, двигатель на антиматерии или солнечные панели), пока по крайней мере один источник питания не будет правильно подключен и настроен.
...
guidebook-SOP-AtmosphericTechnician-right = 1. Полностью перестроить систему жизнеобеспечения при условии, что она не будет перекачивать вредные газы никуда, кроме камер фильтрации или открытого космоса.
...
guidebook-SOP-TechnicalAssistant-must = 1. Содержать станцию в хорошем состоянии.
guidebook-SOP-TechnicalAssistant-right = 1. При нехватке знаний попросить инженера или атмосферного техника выполнить задачу.
guidebook-SOP-TechnicalAssistant-prohibited = 1. Выходить за пределы станции без разрешения старшего инженера или возникновения чрезвычайной ситуации.
