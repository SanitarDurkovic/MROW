...
public sealed class CardDeckSystem : EntitySystem
{
    ...
    private void UpdateSprite(EntityUid uid, CardDeckComponent comp)
    {
        ...
        _cardSpriteSystem.TryHandleLayerConfiguration(
            ...
            {
                _spriteSystem.LayerSetRotation((uid, sprite), layerIndex, Angle.FromDegrees(90));
                _spriteSystem.LayerSetOffset((uid, sprite), layerIndex, new Vector2(0, (comp.YOffset * cardIndex)));
